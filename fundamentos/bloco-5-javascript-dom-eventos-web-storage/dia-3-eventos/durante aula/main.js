...
firstLi.addEventListener("click", addingClass);
secondLi.addEventListener("click", addingClass);
thirdLi.addEventListener("click", addingClass);
...
function redirectToPage() {
  window.location.href = 'https://luc0liv.github.io/';
}
